...
def find_sensitive_data(url: str, patterns_with_colors: List[tuple[str, str]]) -> Optional[List[str]]:
    """
    Downloads the content of a given URL and searches for sensitive data
    using a list of (regex, color) tuples.
...
def main():
    ...
    for url in urls:
        ...
        colored_matches = find_sensitive_data(url, patterns_with_colors)
        if colored_matches:
